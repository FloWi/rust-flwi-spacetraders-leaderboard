...
function Index() {
  return (
    <>
      ...
      <div className="content flex flex-col gap-4 w-11/12 md:w-1/2">
        ...
        <p>
          ...
          that appeared at least once and keep tracking them even if they disappear again. I decided to do it like that
          to keep the number of agents to track low (because of the rate-limit) without the need to maintain a list
          manually.
        </p>
        <p>
