import {createRootRouteWithContext, LinkProps, Outlet, useRouterState} from "@tanstack/react-router";
...
"
              ...
              <a className="ml-auto" href="/docs/swagger-ui" title="Swagger API docs" target="_blank">
